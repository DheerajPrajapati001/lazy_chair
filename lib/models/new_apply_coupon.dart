...
//
//     final couponsData = couponsDataFromJson(jsonString);

import 'dart:convert';

CouponsData couponsDataFromJson(String str) => CouponsData.fromJson(json.decode(str));

String couponsDataToJson(CouponsData data) => json.encode(data.toJson());
...
class CouponsData {
  ...
  List<Coupon>? coupons;
  List<CouponsDataShippingRate>? shippingRates;
  IngAddress? shippingAddress;
  IngAddress? billingAddress;
  List<CouponsDataItem>? items;
  int? itemsCount;
  int? itemsWeight;
  bool? needsPayment;
  bool? needsShipping;
  ...
  factory CouponsData.fromJson(Map<String, dynamic> json) => CouponsData(
    ...
    shippingRates: List<CouponsDataShippingRate>.from(json["shipping_rates"].map((x) => CouponsDataShippingRate.fromJson(x))),
    shippingAddress: IngAddress.fromJson(json["shipping_address"]),
    billingAddress: IngAddress.fromJson(json["billing_address"]),
    items: List<CouponsDataItem>.from(json["items"].map((x) => CouponsDataItem.fromJson(x))),
    ...
    totals: CouponsDataTotals.fromJson(json["totals"]),
...
class CouponsDataItem {
  ...
  factory CouponsDataItem.fromJson(Map<String, dynamic> json) => CouponsDataItem(
    key: json["key"],
    id: json["id"],
...
class CouponsDataShippingRate {
  CouponsDataShippingRate({
    this.packageId,
    this.name,
    this.destination,
    this.items,
  ...
  factory CouponsDataShippingRate.fromJson(Map<String, dynamic> json) => CouponsDataShippingRate(
...
class CouponsDataTotals {
  ...
  factory CouponsDataTotals.fromJson(Map<String, dynamic> json) => CouponsDataTotals(
